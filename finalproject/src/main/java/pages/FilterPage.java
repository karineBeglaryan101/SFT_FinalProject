...
public class FilterPage {
    ...
    private By min = By.className(FilterPageConstants.min);
    private By max = By.xpath(FilterPageConstants.max);
    private By button = By.cssSelector(FilterPageConstants.button);
    private By between = By.xpath(FilterPageConstants.between);
    private By error = By.xpath(FilterPageConstants.errorMessage);
